        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-legacy" data-widget="treeview" role="menu">
                ...
                @if (\Admin::user()->checkUrlAllowAccess(sc_route_admin('admin_order.index')))
                    <!-- SEARCH FORM -->
                    <form action="{{ sc_route_admin('admin_order.index') }}" method="get"
                          class="form-inline m-1 d-block d-sm-none">
                        <div class="input-group input-group-sm">
                            <input name="keyword" class="form-control form-control-navbar" type="search"
                                   placeholder="{{ sc_language_render('admin.order.search') }}" aria-label="Search">
